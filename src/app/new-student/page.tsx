...
export const metadata: Metadata = {
  ...
  description:
    "New at UT Tyler or TJC? Tell us a little about yourself and we'll connect you with the students running what you're interested in.",
};
    ...
    <div className="py-14 sm:py-20">
      <div className="mx-auto max-w-[680px]">
        <div className="text-center">
          ...
          <p className="mx-auto mt-5 max-w-[500px] text-[17px] leading-[1.7] text-ink-warm">
            For students at UT Tyler and TJC — whether you&apos;ve been Catholic your whole life or
            have never been to a Mass.
          </p>
        </div>
