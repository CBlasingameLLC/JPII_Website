  ...
  return (
    <form className="mt-4 flex gap-2" onSubmit={(e) => e.preventDefault()}>
      <input
        ...
        className="min-w-0 flex-1 rounded-pill border border-white/22 bg-white/8 px-[18px] py-3 font-ui text-[13px] text-ivory outline-none placeholder:text-onnavy-dim"
      />
      <button
        type="submit"
